...
2. Once I set up pfSense using the default VMware setup process, I configured pfSense by setting Network Adapter 1 to Bridged mode and Network Adapter to the host-only network created on VMnet1.
